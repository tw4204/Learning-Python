...
class PasswordValidatorHandler(HeaderMixin):
    ...
    def process_request(self, req, resp):
        ...
        try:
            req.context['_body'] = json.loads(body.decode('utf-8'))
...
class PasswordGeneratorHandler(HeaderMixin):
    def on_get(self, req, resp):
        ...
        resp.body = json.dumps(PasswordGenerator.generate(length))
    ...
    def process_request(self, req, resp):
        ...
        try:
            ...
            raise falcon.HTTPBadRequest(
                'Wrong query parameter', '`length` must be a positive integer.')
