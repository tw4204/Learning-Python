...
class HomeView(TemplateView):
    template_name = 'records_app/home.html'

class RecordListView(TemplateView):
    template_name = 'records_app/list.html'
...
class RecordCreateView(EncryptionMixin, SuccessMessageMixin, CreateView):
    template_name = 'records_app/record_add_edit.html'
    form_class = RecordForm
    success_url = reverse_lazy('records_app:add')
...
class RecordUpdateView(EncryptionMixin, SuccessMessageMixin, UpdateView):
    ...
    def form_valid(self, form):
        self.success_url = reverse_lazy('records_app:edit',kwargs={'pk': self.object.pk})
...
class RecordDeleteView(SuccessMessageMixin, DeleteView):
    model = Record
    success_url = reverse_lazy('records_app:list')
